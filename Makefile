.PHONY: loader go header custom install dist

all: custom

custom: zig-out/lib/custom.dll

zig-out/lib/custom.dll: dll.zig extra.zig deps/minhook/src/buffer.c deps/minhook/src/trampoline.c deps/minhook/src/hde/hde32.c deps/minhook/src/hook.c custom/patch.h custom/hooks.h custom/skip.h custom/zig.h custom/go.h custom/wowtypes.h custom/dx_patch.h custom/dll.c custom/patch.cpp custom/dx_patch.cpp custom/skip.c custom/globals.cpp custom/globals.h custom/safequeue.hpp custom/lua.cpp custom/lua.h lib/libwow.a lib/libwow.h
	@zig build
...
DINPUT8.dll: loader/DINPUT8.exp loader/proxy.c
...
dist: DINPUT8.dll zig-out/lib/custom.dll
	@cp DINPUT8.dll dist/
	@cp zig-out/lib/custom.dll dist/
	@zip -r upload/wow-lib-custom.zip dist/
